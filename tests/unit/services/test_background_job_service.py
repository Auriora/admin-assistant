...
class TestBackgroundJobService:
    ...
    def test_init_without_scheduler(self):
        ...
        try:
            ...
            # Ensure the service is closed even if the test fails
            service.close()
    ...
    def test_schedule_daily_archive_job_config_inactive(self, mock_archive_service, mock_user_service):
        ...
        # Close the service created in setup_method to avoid memory leaks
        if hasattr(self, 'service'):
            self.service.close()
        ...
        try:
            ...
            # Ensure the service is closed even if the test fails
            pass  # The service will be closed in teardown_method
