...
def run_unit_tests(verbose=False, coverage=False):
    ...
    if coverage:
        cmd.extend(['--cov=core', '--cov=web', '--cov=cli', '--cov-report=term-missing'])
...
def run_all_tests(verbose=False, coverage=False):
    ...
    if coverage:
        cmd.extend(['--cov=core', '--cov=web', '--cov=cli', '--cov-report=term-missing', '--cov-report=html'])
...
def check_test_coverage():
    ...
    cmd = ['python', '-m', 'pytest', '--cov=core', '--cov=web', '--cov=cli', 
