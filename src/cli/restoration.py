...
restoration_app = typer.Typer(help="Appointment restoration operations")
console = Console()
...
@restoration_app.command("list-configs")
def list_configurations(
    user_id: int = typer.Option(1, "--user", help="User ID to list configurations for"),
):
    ...
    try:
        ...
        if not configurations:
            console.print("[yellow]No restoration configurations found.[/yellow]")
            return
