...
class AuditLog(Base):
    ...
    )  # e.g., 'archive', 'overlap_resolution', 're_archive', 'api_call'
    operation = Column(
        String(128), nullable=False
    )  # e.g., 'calendar_archive', 'resolve_overlap', 'msgraph_api_call'
    resource_type = Column(
        String(64), nullable=True
    )  # e.g., 'appointment', 'calendar', 'user'
