...
class AuditLogRepository:
    ...
    def list_for_user(self, user_id: int, limit: Optional[int] = None, offset: Optional[int] = None) -> List[AuditLog]:
        """List all AuditLog entries for a given user with optional pagination."""
        query = self.session.query(AuditLog).filter_by(user_id=user_id).order_by(desc(AuditLog.created_at))
    ...
    def list_by_action_type(self, action_type: str, user_id: Optional[int] = None, 
    ...
    def list_by_operation(self, operation: str, user_id: Optional[int] = None,
                         limit: Optional[int] = None) -> List[AuditLog]:
    ...
    def list_by_status(self, status: str, user_id: Optional[int] = None,
                      limit: Optional[int] = None) -> List[AuditLog]:
    ...
    def search(self, filters: Dict[str, Any], limit: Optional[int] = None, 
    ...
    def delete_old_entries(self, older_than_date: date, user_id: Optional[int] = None) -> int:
        """
        ...
        query = self.session.query(AuditLog).filter(AuditLog.created_at < cutoff_datetime)
