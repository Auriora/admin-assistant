...
def get_appointment_repository(
    ...
    if use_mock:
        try:
            ...
            raise ImportError("MockMSGraphClient could not be imported. Ensure test dependencies are available.") from e
        ...
        if mock_data is None:
            raise ValueError("graph_client must be provided as mock_data for live MS Graph repository.")
