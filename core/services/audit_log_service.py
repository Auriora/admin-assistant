...
class AuditLogService:
    ...
    def log_archive_operation(self,
                            user_id: int,
                            operation: str,
                            status: str,
        ...
        message = f"Archived {archived_count} appointments from {start_date} to {end_date}"
        if overlap_count > 0:
    ...
    def log_overlap_resolution(self,
                             user_id: int,
                             action_log_id: int,
                             resolution_type: str,
                             status: str,
    ...
    def log_re_archive_operation(self,
                               user_id: int,
                               status: str,
                               source_calendar_uri: str,
                               archive_calendar_id: str,
    ...
    def cleanup_old_logs(self, older_than_days: int, user_id: Optional[int] = None) -> int:
        """
